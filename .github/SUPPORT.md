# Getting help with `qsvaRPkgDemo`

Thank you for using `qsvaRPkgDemo`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/qsvaRPkgDemo`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/qsvaRPkgDemo),
...
[search issues and pull requests](https://github.com/HediaTnani/qsvaRPkgDemo/issues)
